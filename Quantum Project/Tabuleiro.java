...
// ***** VDMTOOLS START Name=TabuleiroSentinel KEEP=NO
  class TabuleiroSentinel extends Sentinel {
    ...
    public final int jogada = 4;

    public final int getPeca = 5;

    public final int fim_ujogo = 6;

    public final int Tabuleiro = 7;

    public final int distancia = 8;

    public final int maiorCasa = 9;

    public final int move_upara = 10;

    public final int pode_ucomer = 11;

    public final int pode_umover = 12;

    public final int casas_uentre = 13;

    public final int existe_upecas = 14;

    public final int muda_ujogador = 15;

    public final int qual_udirecao = 16;

    public final int teste_uFimJogo = 17;
  ...
  private HashSet casas_uentre (final Casa casa1, final Casa casa2) throws CGException {
    ...
    try {
      if (new Boolean(UTIL.equals(qual_udirecao(casa1, casa2), new quotes.vertical())).booleanValue()) {
        ...
        HashSet rexpr_159 = new HashSet();
        HashSet res_s_160 = new HashSet();
        {

          HashSet e_set_166 = new HashSet();
          e_set_166 = new HashSet();
          Integer lb_167 = null;
          Integer var1_168 = null;
          Integer par_169 = null;
          par_169 = (casa1).linha;
          Integer par_171 = null;
          par_171 = (casa2).linha;
          var1_168 = min(par_169, par_171);
          lb_167 = new Integer(var1_168.intValue() + new Integer(1).intValue());
          Integer ub_174 = null;
          Integer var1_175 = null;
          Integer par_176 = null;
          par_176 = (casa1).linha;
          Integer par_178 = null;
          par_178 = (casa2).linha;
          var1_175 = max(par_176, par_178);
          ub_174 = new Integer(var1_175.intValue() - new Integer(1).intValue());
          int ubi_181 = ub_174.intValue();
          for (int count_182 = lb_167.intValue(); count_182 <= ubi_181; count_182++) 
            e_set_166.add(new Integer(count_182));
          Integer i = null;
          {
            for (Iterator enm_184 = e_set_166.iterator(); enm_184.hasNext(); ) {

              Integer elem_183 = UTIL.NumberToInt(enm_184.next());
              i = elem_183;
              Casa res_s_161 = null;
              Character tmpVar_163 = null;
              tmpVar_163 = (casa1).coluna;
              res_s_161 = new Casa(i, tmpVar_163);
              res_s_160.add(res_s_161);
            }
          }
        }
        rexpr_159 = res_s_160;
        ...
        if (new Boolean(UTIL.equals(qual_udirecao(casa1, casa2), new quotes.horizontal())).booleanValue()) {
          ...
          HashSet rexpr_116 = new HashSet();
          HashSet res_s_117 = new HashSet();
          {

            HashSet e_set_132 = new HashSet();
            e_set_132 = new HashSet();
            Integer lb_133 = null;
            Integer var1_134 = null;
            Integer par_135 = null;
            Character tmppar_137 = null;
            tmppar_137 = (casa1).coluna;
            par_135 = UTIL.NumberToInt(num_ucol.get(tmppar_137));
            Integer par_139 = null;
            Character tmppar_141 = null;
            tmppar_141 = (casa2).coluna;
            par_139 = UTIL.NumberToInt(num_ucol.get(tmppar_141));
            var1_134 = min(par_135, par_139);
            lb_133 = new Integer(var1_134.intValue() + new Integer(1).intValue());
            Integer ub_144 = null;
            Integer var1_145 = null;
            Integer par_146 = null;
            Character tmppar_148 = null;
            tmppar_148 = (casa1).coluna;
            par_146 = UTIL.NumberToInt(num_ucol.get(tmppar_148));
            Integer par_150 = null;
            Character tmppar_152 = null;
            tmppar_152 = (casa2).coluna;
            par_150 = UTIL.NumberToInt(num_ucol.get(tmppar_152));
            var1_145 = max(par_146, par_150);
            ub_144 = new Integer(var1_145.intValue() - new Integer(1).intValue());
            int ubi_155 = ub_144.intValue();
            for (int count_156 = lb_133.intValue(); count_156 <= ubi_155; count_156++) 
              e_set_132.add(new Integer(count_156));
            Integer i = null;
            {
              for (Iterator enm_158 = e_set_132.iterator(); enm_158.hasNext(); ) {

                Integer elem_157 = UTIL.NumberToInt(enm_158.next());
                i = elem_157;
                Casa res_s_118 = null;
                Integer tmpVar_119 = null;
                tmpVar_119 = (casa1).linha;
                Character tmpVar_121 = null;
                HashMap tmp_m_122 = new HashMap();
                tmp_m_122 = new HashMap();
                HashMap mapType_124 = num_ucol;
                for (Iterator enm_128 = mapType_124.keySet().iterator(); enm_128.hasNext(); ) {

                  Object dom_129 = enm_128.next();
                  Character id_d_126 = (Character) dom_129;
                  Integer id_r_125 = UTIL.NumberToInt(mapType_124.get(dom_129));
                  if (tmp_m_122.containsKey(id_r_125)) 
                    UTIL.RunTime("Run-Time Error:Map is not injective - \'inverse\' fails");
                  else 
                    tmp_m_122.put(id_r_125, id_d_126);
                }
                tmpVar_121 = (Character) tmp_m_122.get(i);
                res_s_118 = new Casa(tmpVar_119, tmpVar_121);
                res_s_117.add(res_s_118);
              }
            }
          }
          rexpr_116 = res_s_117;
          ...
          if (new Boolean(UTIL.equals(qual_udirecao(casa1, casa2), new quotes.diagonal1())).booleanValue()) {
            ...
            HashSet res_s_66 = new HashSet();
            {
              ...
              HashSet e_set_92 = new HashSet();
              e_set_92 = new HashSet();
              Integer ub_94 = null;
              Integer var1_95 = null;
              Integer var1_96 = null;
              Integer par_97 = null;
              par_97 = (casa1).linha;
              Integer par_99 = null;
              par_99 = (casa2).linha;
              var1_96 = max(par_97, par_99);
              Integer var2_101 = null;
              Integer par_102 = null;
              par_102 = (casa1).linha;
              Integer par_104 = null;
              par_104 = (casa2).linha;
              var2_101 = min(par_102, par_104);
              var1_95 = new Integer(var1_96.intValue() - var2_101.intValue());
              ub_94 = new Integer(var1_95.intValue() - new Integer(1).intValue());
              int ubi_107 = ub_94.intValue();
              for (int count_108 = new Integer(1).intValue(); count_108 <= ubi_107; count_108++) 
                e_set_92.add(new Integer(count_108));
              Integer i = null;
              {
                for (Iterator enm_110 = e_set_92.iterator(); enm_110.hasNext(); ) {

                  Integer elem_109 = UTIL.NumberToInt(enm_110.next());
                  i = elem_109;
                  Casa res_s_67 = null;
                  Integer tmpVar_68 = null;
                  Integer var1_69 = null;
                  var1_69 = (maiorCasa(casa1, casa2)).linha;
                  tmpVar_68 = new Integer(var1_69.intValue() - i.intValue());
                  Character tmpVar_74 = null;
                  HashMap tmp_m_75 = new HashMap();
                  tmp_m_75 = new HashMap();
                  HashMap mapType_77 = num_ucol;
                  for (Iterator enm_81 = mapType_77.keySet().iterator(); enm_81.hasNext(); ) {

                    Object dom_82 = enm_81.next();
                    Character id_d_79 = (Character) dom_82;
                    Integer id_r_78 = UTIL.NumberToInt(mapType_77.get(dom_82));
                    if (tmp_m_75.containsKey(id_r_78)) 
                      UTIL.RunTime("Run-Time Error:Map is not injective - \'inverse\' fails");
                    else 
                      tmp_m_75.put(id_r_78, id_d_79);
                  }
                  Integer tmppar_83 = null;
                  Integer var1_84 = null;
                  Character tmppar_86 = null;
                  tmppar_86 = (maiorCasa(casa1, casa2)).coluna;
                  var1_84 = UTIL.NumberToInt(num_ucol.get(tmppar_86));
                  tmppar_83 = new Integer(var1_84.intValue() + i.intValue());
                  tmpVar_74 = (Character) tmp_m_75.get(tmppar_83);
                  res_s_67 = new Casa(tmpVar_68, tmpVar_74);
